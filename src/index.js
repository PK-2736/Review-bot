...
const remarkableEnableCommand = require('./commands/remarkable_ignore');
...
client.commands.set('remarkable_enable', remarkableEnableCommand);

// スラッシュコマンドの登録
const commands = [todayCommand.data.toJSON(), doneCommand.data.toJSON(), scheduleCommand.data.toJSON(), reminderCommand.data.toJSON(), classroomCommand.data.toJSON(), remarkableSyncCommand.data.toJSON(), remarkableCacheCommand.data.toJSON(), remarkableEnableCommand.data.toJSON()];
